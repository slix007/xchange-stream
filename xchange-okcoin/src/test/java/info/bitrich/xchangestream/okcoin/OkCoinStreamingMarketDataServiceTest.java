...
public class OkCoinStreamingMarketDataServiceTest {
    ...
    public void testGetOrderBook() throws Exception {
        ...
        final Date date = new Date(1484602135246L);
        bids.add(new LimitOrder(Order.OrderType.BID, new BigDecimal("0.922"), CurrencyPair.BTC_USD, null, date, new BigDecimal("819.9")));
        bids.add(new LimitOrder(Order.OrderType.BID, new BigDecimal("0.085"), CurrencyPair.BTC_USD, null, date, new BigDecimal("818.63")));

        List<LimitOrder> asks = new ArrayList<>();
        asks.add(new LimitOrder(Order.OrderType.ASK, new BigDecimal("0.035"), CurrencyPair.BTC_USD, null, date, new BigDecimal("821.6")));
        asks.add(new LimitOrder(Order.OrderType.ASK, new BigDecimal("5.18"), CurrencyPair.BTC_USD, null, date, new BigDecimal("821.65")));
        asks.add(new LimitOrder(Order.OrderType.ASK, new BigDecimal("2.89"), CurrencyPair.BTC_USD, null, date, new BigDecimal("821.7")));

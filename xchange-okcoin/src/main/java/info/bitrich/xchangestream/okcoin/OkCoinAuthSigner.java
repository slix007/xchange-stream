...
public class OkCoinAuthSigner {
    ...
    private final Comparator<Map.Entry<String, String>> comparator = Comparator.comparing(Map.Entry::getKey);

    public OkCoinAuthSigner(String apikey, String secretKey) {
